...
function custom_types_register() {
	...
	// CUSTOM POST TYPE
	$cpt_args = array(
		'labels' 				=> get_custom_post_type_labels($post_name, 'Member', 'People'),
		'description'       	=> '',
		'public'                => true,
	    'show_ui'               => true,
	    'show_in_menu'          => true,
	...
	// CUSTOM POST TYPE
	$cpt_args = array(
		'labels' 				=> get_custom_post_type_labels($post_name, 'Publication', 'Publications'),
		'description'       	=> '',
		'public'                => true,
	    'show_ui'               => true,
	    'show_in_menu'          => true,
	...
	$args = array(
	    'label'                         => 'Year',
	    'labels'						=> get_custom_post_type_labels($taxonomy, 'Year', 'Years'),
	    'public'                        => false,
	    'hierarchical'                  => true,
	    'show_ui'                       => true,
	    'show_in_nav_menus'             => true,
	    'args'                          => array( 'orderby' => 'slug', 'order' => 'DESC' ),
	    //'rewrite'                       => array( 'slug' => 'project' ) // array( 'slug' => 'project', 'with_front' => false )
	    //'query_var'                     => true
	);
...
/*function add_custom_taxonomy_to_permalink() {
	...
	$post_name    = 'project';
	$taxonomy     = 'project-category';
	$rewrite_slug = 'projects'; // The rewrite slug set in 'register_post_type'
...
/*function project_change_columns($defaults) {
    $defaults['project-category'] = 'Category';
    return $defaults;
}
...
function taxonomy_filter_restrict_manage_posts() {
    ...
    // If you only want this to project for your specific post type,
